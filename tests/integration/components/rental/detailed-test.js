...
module('Integration | Component | rental/detailed', function (hooks) {
  ...
  // beforeEach hook is used to share some boilerplate code which allows us ot have two or more tests that each focus on a different, single aspect of the component.
  ...
  test('it renders a header with a share button', async function (assert) {
    await render(hbs`<Rental::Detailed @rental={{this.rental}} />`); // this.rental stem from beforeEach hook

...
module('Unit | Model | rental', function (hooks) {
  ...
  test('it has the right type', function (assert) {
    let store = this.owner.lookup('service:store'); // A service known as Ember Data store. This API is used to get access to the Ember Data store. Also provides a `createRecord` method to instantiate our model object
